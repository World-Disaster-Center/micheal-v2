    ...
    <nav className="bg-white fixed w-full flex items-center justify-between py-3 px-6 md:px-20">
      ...
      <div className="hidden md:flex gap-12 items-center">
        ...
        <div className="flex gap-3 items-center">
          <button className="border border-michael_red_100 px-4 text-michael_black_1 font-medium py-1 rounded-lg text-[12px] hover:text-michael_red_100">Sign in</button>
