   ...
   >
     ...
     <div className="hidden md:flex gap-12 items-center">
       ...
       <div className="flex gap-3 items-center">
         <button className={`${ isScrolled ? 'text-michael_red-100' : 'text-white'
           } border border-michael_red_100 px-4 font-medium py-1 rounded-lg text-[12px] hover:bg-michael_dark_red_50`}>
           Sign in
         </button>
         <button className="py-1 px-4 bg-michael_red_100 rounded-lg text-white text-[12px] hover:text-michael_gray_2">
           Register
         </button>
         <button
     ...
     >
       ...
       <nav className="flex flex-col gap-6 justify-center text-center">
         ...
         <button className="border border-michael_red_100 px-4 mx-auto text-michael_red_100 font-semibold py-2 rounded-lg w-[70%] text-[12px] hover:bg-michael_dark_red_50">
           Sign in
         </button>
         <button className="py-2 px-4 bg-michael_red_100 mx-auto rounded-lg font-semibold text-white text-[12px] w-[70%] hover:text-michael_gray_2">
           Register
         </button>
       </nav>
     </div>
